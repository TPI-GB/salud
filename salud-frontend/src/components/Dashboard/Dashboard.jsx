        ...
        <Grid container spacing={3} className={classes.container}>
          <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
            <CardHeader
              ...
              titulo="Cantidad Semanal de Pacientes"
              texto="Muestra la cantidad de pacientes/semana"
              color="red"
            />
          </Grid>
          ...
          <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
            <CardHeader
              ...
              titulo="Porcentaje de patologias"
              texto="Muestra las patologias mas comunes"
              color="red"
            />
          </Grid>
